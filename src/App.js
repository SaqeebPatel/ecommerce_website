...
//           <Route path="/Product/:prodId" element={<ProductDetails data={Products}/>}/>
//       </Routes>
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/login" element={<Login />} />
        <Route path="/cart" element={<Cart data={Products} addToCart={addToCart} />} />
        <Route path="/Product/:prodId" element={<ProductDetails data={Products} addToCart={addToCart} />} />
      </Routes>
      <br />
    </div>
  );
